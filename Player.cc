...
bool Player::isCorrectShooting() {
    ...
    if (Shooting.size()==2) {
        if (Shooting[0]== '1' || Shooting[0]== '2' || Shooting[0]== '3' || Shooting[0] == '4' || Shooting[0]== '5' || Shooting[0]== '6' || Shooting[0]== '7' || Shooting[0]== '8' || Shooting[0]== '9') {
            if (Shooting[1] == 'A' || Shooting[1] == 'B' || Shooting[1] == 'C' || Shooting[1] == 'D' ||Shooting[1] == 'E' || Shooting[1] == 'F' || Shooting[1] == 'G' || Shooting[1] == 'H' || Shooting[1] == 'I' ||Shooting[1] == 'J') {
                return true;
            }return false;
        }return false;
    }
    ...
    if (Shooting.size()==3) {
        if (Shooting[0]=='1' || Shooting[1]=='0') {
            if (Shooting[2] == 'A' || Shooting[2] == 'B' || Shooting[2] == 'C' || Shooting[2] == 'D' ||Shooting[2] == 'E' || Shooting[2] == 'F' || Shooting[2] == 'G' || Shooting[2] == 'H' || Shooting[2] == 'I' ||Shooting[2] == 'J') {
                return true;
            }return false;
        }return false;
    }return false;

...
for (int i=0; i < i+1; i++) {
    ...
    // Initialize the game ongoing variable
    ...
    while (GameOngoing)
    {
        ...
        for (int i = 0; i <= 3; i++) {
            instructions.OneMastedInstructions(i);
            ...
            if (Positioning.isCorrect()){
                ...
                else
                {
                    ...
                    Clearing.Clear();
                    Player1Board.displayPlayerGrid();
                    std::cout << "This Location is not avaliable on the board.Try again\n";
                    i--;
                    Positioning.~ships();
                }
            }
        ...
        // Placing Two-Masted Ships
        for (int i = 0; i <= 2; i++) {
            instructions.TwoMastedInstructions(i);
            ...
            if (Positioning.isCorrectNMasted()){
                ...
                bool IsAvaliable = Player1Board.CheckIfAvaliable(coordinate1, coordinate2,2, direction);
                getchar();
                if (IsAvaliable == true)
                {
                    Clearing.Clear();
                    Player1Board.PlaceShip(coordinate1, coordinate2,2, direction);
                    Player1Board.displayPlayerGrid();
                    Positioning.~ships();
                }
                else
        ...
        // Placing Three-Masted Ships
        for (int i = 0; i <= 1; i++) {
            instructions.ThreeMastedInstructions(i);
            ...
            if (Positioning.isCorrectNMasted()){
                ...
                bool IsAvaliable = Player1Board.CheckIfAvaliable(coordinate1, coordinate2,3, direction);
                getchar();
                if (IsAvaliable == true)
                {
                    Clearing.Clear();
                    Player1Board.PlaceShip(coordinate1, coordinate2,3, direction);
                    Player1Board.displayPlayerGrid();
                    Positioning.~ships();
                }
                else
        ...
        // Placing four-Masted Ship
        for (int i = 0; i <= 0; i++) {
            instructions.FourMastedInstructions(i);
            ...
            if (Positioning.isCorrectNMasted()){
                ...
                bool IsAvaliable = Player1Board.CheckIfAvaliable(coordinate1, coordinate2,4, direction);
                getchar();
                if (IsAvaliable == true)
                {
                    Clearing.Clear();
                    Player1Board.PlaceShip(coordinate1, coordinate2,4, direction);
                    Player1Board.displayPlayerGrid();
                    std::cout << "Press Enter to end your placing";
                    getchar();
                    Positioning.~ships();
                    Clearing.Clear();
        ...
        for (int i = 0; i <= 2; i++) {
            ...
            if (Positioning.isCorrectNMasted()){
                ...
                bool IsAvaliable = Player2Board.CheckIfAvaliable(coordinate1, coordinate2,2, direction);
getchar();
                if (IsAvaliable == true)
                {
                    Clearing.Clear();
                    Player2Board.PlaceShip(coordinate1, coordinate2,2, direction);
                    Player2Board.displayPlayerGrid();
                    Positioning.~ships();
                }
                else
        ...
        for (int i = 0; i <= 1; i++) {
            ...
            if (Positioning.isCorrectNMasted()){
                ...
                bool IsAvaliable = Player2Board.CheckIfAvaliable(coordinate1, coordinate2, 3,direction);
getchar();
                if (IsAvaliable == true)
                {
                    Clearing.Clear();
                    Player2Board.PlaceShip(coordinate1, coordinate2,3, direction);
                    Player2Board.displayPlayerGrid();
                    Positioning.~ships();
                }
                else
        ...
        for (int i = 0; i <= 0; i++) {
            ...
            if (Positioning.isCorrectNMasted()){
                ...
                bool IsAvaliable = Player2Board.CheckIfAvaliable(coordinate1, coordinate2, 4,direction);
getchar();
                if (IsAvaliable == true)
                {
                    Clearing.Clear();
                    Player2Board.PlaceShip(coordinate1, coordinate2, 4,direction);
                    Player2Board.displayPlayerGrid();
                    Positioning.~ships();
                }
                else
